  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] flex relative overflow-hidden">
        ...
        <nav className="flex-1 overflow-y-auto p-4">
          <ul className="space-y-2">
            {menuItems.map((item) => {
              ...
              const isActive = item.path === '/leaves' || 
                (item.path === '/home' && window.location.pathname === '/home');
              return (
                <li key={item.id}>
                  <button
                    onClick={() => {
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'ml-72' : 'ml-20'}`}>
          ...
          <div className="px-6 py-4 flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Apply for leaves and track their status</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
        ...
        {/* Page Content */}
        <div className="p-6">
          {/* Header with Action Button - FIXED: Button now properly clickable */}
      ...
      {/* Leave Form Modal - Fixed z-index and click handling */}
      <AnimatePresence>
        {showForm && (
          <LeaveForm
