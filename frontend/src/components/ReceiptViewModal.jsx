          ...
          <div className="preview-receipt bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            <div className="p-8 md:p-10">
              ...
              <div className="pt-4 mt-2 border-t-2 border-gray-200 text-center">
                ...
                {/* {(receipt.viewCount > 0 || receipt.downloadCount > 0) && (
                  <p className="text-xs text-gray-400 mt-1">
                    {receipt.viewCount > 0 && `Viewed ${receipt.viewCount} times`}
                    {receipt.downloadCount > 0 && ` • Downloaded ${receipt.downloadCount} times`}
                  </p>
                )} */}
              </div>
            </div>
